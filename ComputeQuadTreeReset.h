...
Description:
    ...
    nodes is not 0), and the values in each node are set such that they effectively rendred 
    inert.
...
{
public:
    ComputeQuadTreeReset(unsigned int numStartingNodes, unsigned int maxNodes, const std::string computeShaderKey);
